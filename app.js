...
const SUPER_ALFVENIC_COLORMAP_FRACTION_BELOW_ALFVEN = 0.5;
...
function renderJetSurface(solution) {
  ...
  const colorPivot = solution?.scenario === 'A' && Number.isFinite(rhoPsiAtZA) && rhoPsiAtZA > 0
    ? {
        logDensity: Math.log10(rhoPsiAtZA),
